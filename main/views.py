...
stripe.api_key='sk_test_51KE9XaFNjk8sc2rXIiwWKCOFeyx3A148Xyt4yFLq7NYViyRq8zKAGC9pcG1HLWEzRydA9jcH27K7EKXPSwk4rRSt00EFhcqJKt'
def checkout_session(request,plan_id):
	...
	session=stripe.checkout.Session.create(
	    ...
	    cancel_url='http://127.0.0.1:8000/pay_cancel',client_reference_id=plan_id
	)
...
def pay_success(request):
	...
	from_email='sirajkhanmardan123@gmail.com'

	msg = EmailMessage(subject, html_content, from_email, ['sirajulislam.khilji@gmail.com'])
